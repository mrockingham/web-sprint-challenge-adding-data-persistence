...
relation databases are the actual database software and sql is used to query or interact with the data base


2. Why do tables need a `primary key`?

the main reasons is to implement a relationshhip between two tables. It also helps in maintaing and working with data
...
foreign keys and a table that acts as a bridge between many tables
